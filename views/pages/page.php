...
<form id="form" action="" class="col-md-12" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group">
                        <label for="text1" class="control-label ">Titre</label>
                        <div class="">
						<input class="text-input form-control" name="title" id="txttitle" type="text" value="<?php echo $data["title"]; ?>"  /> (Ex. Mahmoud harran)
					</div></div>
...
<div class="modal fade bs-example-modal-lg" id="mediaModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="panel-heading">
                            <label class="panel-title">fichiers médias</label>
                        </div>
                        <div id="mediafiles">
    ...
    <? common::plugins("tinymce/tinymce"); ?>
...
<script src="<?=SITE_URL."/".PLUGIN_DIR."uploadify/"; ?>jquery.uploadify.min.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="<?=SITE_URL."/".PLUGIN_DIR."uploadify/"; ?>uploadify.css">
    ...
    <script>
          ...
          $('#file_upload').uploadify({
    				...
    				'swf'      : '<?=SITE_URL."/".PLUGIN_DIR."uploadify/"; ?>uploadify.swf',
    				'uploader' : '<?=SITE_URL."/".PLUGIN_DIR."uploadify/"; ?>uploadmedia.php',
          ...
          $.ajax({
              type: "POST",
              url: "<? echo SITE_URL."/".PLUGIN_DIR."media/load.php"; ?>",
              data: {  }
            })
              .done(function( msg ) {
