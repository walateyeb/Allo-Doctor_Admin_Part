...
<div class="panel panel-default">
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-2">Nom de Clinique<span class="">*</span></label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                            ...
                            <label for="text1" class="control-label col-lg-1">Remise<span>*</span></label>
                            <div class="col-lg-2">
    						  <input class="text-input form-control" name="discount" id="txtdiscount" type="number" required="" /> 
                            </div>
                            <div class="col-lg-1">
                               %.
                            </div>
                   ...
                   <div class="form-group">
                        <label for="text1" class="control-label col-lg-2">équippement</label>
                        <div class="col-lg-6">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                    ...
                                    <? foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="<?=common::get_component_link(array("clinic","timetable"),array("cl_id"=>$d["cl_id"],"dr_id"=>common::get_control_value("dr_id")))?>" class="btn btn-default">Régler le temps</a></td>
                                            <td class="center">
