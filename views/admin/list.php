...
<div class="" id="wrap">
        ...
        <div id="content">
		    ...
		    <div class="block">
                ...
                <a href="<?=common::get_component_link(array('admin','add')); ?>" class="btn btn-primary f_right " style="float: right;" >Ajouter/a>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                	...
                	<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                            ...
                            <? foreach($data as $val){ ?>
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="<?=common::get_component_link(array('admin','edit')).'&id='.$val['id']; ?>" title="Edit"><i class="fa fa-edit"></i></a>
										 <a href="<?=common::get_component_link(array('admin','delete')).'&id='.$val['id']; ?>" title="Delete"><i class="glyphicon glyphicon-remove"></i></a> 
			...
			<div class="clear"></div> <!-- End .clear -->
 			...
 			<div id="footer">
				<small> <!-- Remove this notice or replace it with whatever you want -->
						&#169; Copyright 2015-2016 PFE | Développer par <a href="http://waywebsolution.com">Walè & Ismail</a> | <a href="#">haut</a>
				</small>
			</div><!-- End #footer -->
<script src="<?=ADMIN_THEME; ?>lib/jquery.min.js"></script>
    ...
    <script type="text/javascript" src="<?=ADMIN_THEME; ?>js/style-switcher.js"></script>
  </body>
</html>