        ...
        <div id="content">
              ...
              <div class="col-lg-6">
                <div class="box dark">
                  <header>
                    ...
                    <h5>Ajouter nouveau utilisateur</h5>
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Nom d'utilisateur</label>
                        <div class="col-lg-8">
						<input class="text-input" name="username" value="<?=$data["username"]; ?>" type="text" />
					   </div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Mot de passe</label>
                        <div class="col-lg-8">
                        <input class="text-input" name="temppassword" value="<?=$data["password"]; ?>" type="hidden" />
						<input class="text-input" name="password" value="<?=$data["password"]; ?>" type="password" />
					</div>
                    </div>
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Email</label>
                        <div class="col-lg-8">
						<input class="text-input" name="email" type="email" value="<?=$data["email"]; ?>" />
					</div>
                    </div>
                    <div class="form-group">
 			...
 			<div id="footer">
				<small> <!-- Remove this notice or replace it with whatever you want -->
						&#169; Copyright 2015-2016 PFE | développer par<a href="http://waywebsolution.com">Walè & Ismail </a> | <a href="#">Top</a>
				</small>
			</div><!-- End #footer -->
