...
<div class="row">
<div class="col-lg-12">
<h1 class="page-header"><i class="fa fa-folder fa-fw"></i> Ajouter Catégorie
...
<div class="panel panel-default">
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
						<input class="text-input form-control" name="title" id="txttitle" type="text" required="" /> (Ex. ABC )
					</div>
                    </div>
                   <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Image D'icon : </label>
                        <div class="col-lg-8">
