...
<script src="<?=PLUGIN_DIR."uploadify/"; ?>jquery.uploadify.min.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="<?=PLUGIN_DIR."uploadify/"; ?>uploadify.css">
<script>
          ...
          $('#file_upload').uploadify({
    				...
    				'swf'      : '<?=PLUGIN_DIR."uploadify/"; ?>uploadify.swf',
    				'uploader' : '<?=PLUGIN_DIR."uploadify/"; ?>uploadmedia.php',
          ...
          $.ajax({
              type: "POST",
              url: "<? echo PLUGIN_DIR."media/load.php"; ?>",
              data: {  }
            })
              .done(function( msg ) {
